	      ...
	      <div class="row">
	        ...
	        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
						<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2">
							<h1 class="h2"><span class="fa fa-fw fa-user"></span> Personnel</h1>
							...
							<table class="table table-striped table-md">
								...
								<tbody>
									<tr>
										...
										<td><span class="btn-primary btn-sm" href="#" role="button">Administrator</span></td>
									</tr>
									<tr>
										<td><input class="form-control" type="checkbox" name=""></td>
										<td>2</td>
										<td>USR-0002</td>
										<td><a><img src="assets/images/upoulogo.png" alt="..." class="img-profile-sm img-thumbnail rounded-circle">Lorem, Ipsum Dolor</a></td>
										<td><span class="btn-danger btn-sm" href="#" role="button">Deactive</span></td>
										<td><span class="btn-primary btn-sm" href="#" role="button">Administrator</span></td>
									</tr>
									<tr>
										<td><input class="form-control" type="checkbox" name=""></td>
									...
									<tr>
										...
										<td>USR-0006</td>
										<td><a><img src="assets/images/upoulogo.png" alt="..." class="img-profile-sm img-thumbnail rounded-circle">Lorem, Ipsum Dolor</a></td>
										<td><span class="btn-warning btn-sm" href="#" role="button">New</span></td>
										<td><span class="btn-primary btn-sm" href="#" role="button">Administrator</span></td>
									</tr>
									<tr>
										<td><input class="form-control" type="checkbox" name=""></td>
										...
										<td><a><img src="assets/images/upoulogo.png" alt="..." class="img-profile-sm img-thumbnail rounded-circle">Lorem, Ipsum Dolor</a></td>
										<td><span class="btn-success btn-sm" href="#" role="button">Active</span></td>
										<td><span class="btn-warning btn-sm" href="#" role="button">User</span></td>
									</tr>
									<tr>
										<td><input class="form-control" type="checkbox" name=""></td>
										<td>8</td>
